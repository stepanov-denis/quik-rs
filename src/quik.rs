...
///  Callback function to get information about the request parameters.
...
/// Represents the state of application receipt.
#[derive(Debug, PartialEq)]
pub enum Mode {
    NewApplication,
    InitialReceiptInProgress,
    LastApplicationReceived,
    Unknown,
}
...
impl From<c_long> for Mode {
    fn from(code: c_long) -> Self {
        match code {
            0 => Mode::NewApplication,
            1 => Mode::InitialReceiptInProgress,
            2 => Mode::LastApplicationReceived,
            _ => Mode::Unknown,
        }
    }
}
...
#[derive(Debug, PartialEq)]
pub enum TransId {
    /// Represents a valid transaction ID.
    Id,
    /// Represents an unknown transaction ID, or a case where the request wasn't generated by a valid transaction.
    Unknown,
}
